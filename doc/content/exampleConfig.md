# Example XML configuration for Real GPS mod

In this example is used every possible attribute and node you can use while configuring your map.

Values used in this example is default values. You can modify any value in your configuration.
